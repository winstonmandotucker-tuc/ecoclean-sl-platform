...
- 27 July 2026 — established the commercial operating plan for ECOCLEAN SL. Essential citizen reporting remains free while municipal licences, commercial and household subscriptions, on-demand collections, recycling, sponsorship, training and environmental intelligence fund operations. Required billing capabilities, illustrative pilot economics, decision gates, external providers and unresolved cost quotations are documented in [docs/BUSINESS_MODEL_AND_REVENUE_PLAN.md](docs/BUSINESS_MODEL_AND_REVENUE_PLAN.md) and [docs/EXTERNAL_DEPENDENCY_AND_COST_REGISTER.md](docs/EXTERNAL_DEPENDENCY_AND_COST_REGISTER.md).
